...
describe('+ AuthController', () => {
  ...
  describe('+ GET: /connect', () => {
    it('+ Fails with no "Authorization" header field',  (done) =>{
      this.timeout(5000);
      request.get('/connect')
        .expect(401)
        .end((err, res) => {
    ...
    it('+ Fails with a valid email and wrong password',  (done) =>{
      this.timeout(5000);
      request.get('/connect')
    ...
    it('+ Fails with an invalid email and valid password',  (done) =>{
      this.timeout(5000);
      request.get('/connect')
    ...
    it('+ Succeeds for an existing user',  (done) =>{
      this.timeout(5000);
      request.get('/connect')
