...
describe('+ FilesController', () => {
  ...
  describe('+ POST: /files', () => {
    ...
    it('+ Fails for a non-existent user',  (done) =>{
      this.timeout(5000);
      request.post('/files')
        .set('X-Token', 'raboof')
        .expect(401)
    ...
    it('+ Fails if data is missing and type is not a folder',  (done) =>{
      this.timeout(5000);
      request.post('/files')
        .set('X-Token', token)
    ...
    it('+ Succeeds for valid values of a file',  (done) =>{
      this.timeout(5000);
      request.post('/files')
        .set('X-Token', token)
        .send({
    ...
    it('+ Fails if parentId is set and is not of a folder or 0',  (done) =>{
      this.timeout(5000);
      request.post('/files')
        .set('X-Token', token)
        .send({
    ...
    it('+ Succeeds if parentId is set and is of a folder',  (done) =>{
      this.timeout(5000);
      request.post('/files')
        .set('X-Token', token)
        .send({
  ...
  describe('+ GET: /files/:id', () => {
    ...
    it('+ Fails if file is not linked to user',  (done) =>{
      this.timeout(5000);
      request.get('/files/444555666')
        .set('X-Token', token)
        .expect(404)
    ...
    it('+ Succeeds if file is linked to user',  (done) =>{
      this.timeout(5000);
  ...
  describe('+ GET: /files', () => {
    ...
    it('+ Fetches first page with no page query',  (done) =>{
      this.timeout(5000);
      request.get('/files')
        .set('X-Token', token)
        .expect(200)
    ...
    it('+ Fetches first page with no page query and parentId',  (done) =>{
      this.timeout(5000);
    ...
    it('+ Returns empty list for a page that is out of bounds',  (done) =>{
      this.timeout(5000);
    ...
    it('+ Returns empty list for a parentId of a file',  (done) =>{
      this.timeout(5000);
    ...
    it('+ Returns empty list for unknown parentId',  (done) =>{
      this.timeout(5000);
  ...
  describe('+ GET: /files/:id/data', () => {
    ...
    it('+ Fails if the file is a folder',  (done) =>{
      this.timeout(5000);
    ...
    it('+ Succeeds if the file is not public but requested by the owner [alt]',  (done) =>{
    ...
    it('+ Fails if the file is not locally present',  (done) =>{
      this.timeout(5000);
      emptyFolder(baseDir);
      request.get(`/files/${mockFiles[2].id}/data`)
        .expect(404)
